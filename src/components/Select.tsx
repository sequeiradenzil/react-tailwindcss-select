    ...
    return (
        ...
        >
            <div className="relative w-full" ref={ref}>
                ...
                {(open && !isDisabled) && (
                    <div tabIndex={-1} className="top-[120px] z-[100] sm:ml-[15%] md:ml-[30%] max-w-md fixed inset-x-0 bottom-0 w-full bg-white shadow-lg border rounded py-1 mt-1.5 text-sm text-gray-700">
                        {isSearchable && (
                            <SearchInput
                                value={inputValue}
